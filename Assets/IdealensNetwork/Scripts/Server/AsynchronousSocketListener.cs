...
public class AsynchronousSocketListener : SingletonMonoBehaviour<AsynchronousSocketListener>
{
    ...
    public List<Socket> activeConnections = new List<Socket>();
    ...
    public void AcceptCallback(IAsyncResult ar)
    {
        ...
        ServerCMDController.Instance.SendCurrentInfo(state.workSocket, 3);

        //if (ServerUIController.Instance.clients.ContainsKey(ipAddres))
        //{
        //    Debug.LogFormat("ip: {0} reconnected !", ipAddres);
    ...
    private void SendCallback(IAsyncResult ar)
    {
        ...
        {
            Debug.Log(e.ToString());
            string _ip = ((IPEndPoint)handler.RemoteEndPoint).Address.ToString();
            OnClientDisconnectEvent(_ip);
